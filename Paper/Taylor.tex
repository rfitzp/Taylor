...
This paper  investigates the response of an idealized cylindrical  tokamak plasma to a static resonant magnetic
perturbation (RMP),  resonant at a single rational surface in the plasma,  that is suddenly switched on. The problem under discussion is an extension of one considered in a well-known paper by
...
In the outer region, the perturbed magnetic field can be written $\delta {\bf B} = \nabla\delta \psi\times{\bf e}_z$, where
...
\subsection{Introduction}
The inner region, which lies in the immediate vicinity of the rational surface, is assumed to be governed by the  four-field model described in Ref.~\onlinecite{err3}. This
...
$d_i = \sqrt{m_i/(n_0\,e^{\,2}\,\mu_0)_{e_s}}$ the collisionless ion skin-depth,
...
theelectron diamagnetic requency,
