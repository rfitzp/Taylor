...
\begin{equation}
\hat{\delta}_{VI}(\hat{t}) = \frac{1}{\hat{t}^{\,1/2}}\left[1+(Q_E+Q_e)^2\,\hat{t}^{\,2}\right]^{1/8}\,P_\varphi^{\,1/4}.
\end{equation}
...
Equatons~(\ref{ri1}) and (\ref{cp}) yield 
\begin{equation}
...
Eqautions~(\ref{sc1}) and (\ref{cp}) yield 
\begin{equation}
...
The layer widths calculated in Sects.~\ref{inertial}--\ref{diffusive} allow us to determine how the plasma response in the resonant layer
navigates through the various reconnection regimes. This navigation is illustrated in Figs.~\ref{f3} and \ref{f4}.
