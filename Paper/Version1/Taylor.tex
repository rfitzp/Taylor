...
In Refs.~\onlinecite{err2} and \onlinecite{err3}, the resonant layer equations are solved by means of a Fourier transform in space, and a Fourier transform in time,
...
space, and a Laplace transform in time, which is appropriate to the study of time-dependent RMPs. Much of the analysis of Refs.~\onlinecite{err2} and \onlinecite{err3}
