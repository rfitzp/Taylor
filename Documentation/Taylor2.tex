...
where
\begin{equation}
\epsilon_{VR} = \frac{\Gamma(1/6)}{6^{2/3}\,\pi\,\Gamma(5/6)}\,\frac{1}{{\mit\Sigma}\,P_\varphi^{\,1/6}}.
\end{equation}
Thus,
\begin{align}
...
\,\frac{\epsilon_{DR}}{{\rm i}\,(Q_E+Q_e)+\epsilon_{DR}}\left(\frac{1}{g} - \frac{1}{g + [{\rm i}\,(Q_E+Q_e)+\epsilon_{DR}]}\right),
\end{align}
giving
\begin{align}
